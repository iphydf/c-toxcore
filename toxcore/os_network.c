...
static int os_bind(void *_Nonnull self, Socket sock, const Network_Addr *_Nonnull addr)
{
...
static int os_connect(void *_Nonnull self, Socket sock, const Network_Addr *_Nonnull addr)
{
...
static int os_sendto(void *_Nonnull self, Socket sock, const uint8_t *_Nonnull buf, size_t len, const Network_Addr *_Nonnull addr)
{
    return sendto(net_socket_to_native(sock), (const char *)buf, len, 0, (const struct sockaddr *)&addr->addr, addr->size);
}

static int os_recvfrom(void *_Nonnull self, Socket sock, uint8_t *_Nonnull buf, size_t len, Network_Addr *_Nonnull addr)
{
...
static int os_getaddrinfo(void *_Nonnull obj, const Tox_Memory *_Nonnull mem, const char *_Nonnull address, int family, int sock_type, Network_Addr *_Nonnull *_Nonnull addrs)
{
...
static int os_freeaddrinfo(void *_Nonnull obj, const Tox_Memory *_Nonnull mem, Network_Addr *_Nonnull addrs)
{
    if (addrs == nullptr) {
        return 0;
    }
