...
static void tox_stop_loop_async(struct ev_loop *_Nonnull dispatcher, ev_async *_Nonnull listener, int events)
{
...
static void tox_do_iterate(struct ev_loop *_Nonnull dispatcher, ev_io *_Nonnull sock_listener, int events)
{
