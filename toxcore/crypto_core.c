...
static uint8_t *crypto_malloc(non_null() const Memory *mem, size_t bytes)
{
...
static void crypto_free(non_null() const Memory *mem, nullable() uint8_t *ptr, size_t bytes)
{
    if (ptr != nullptr) {
