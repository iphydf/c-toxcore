 ...
 */
static int receivepacket(non_null() const Network *ns, non_null() const Memory *mem, non_null() const Logger *log, Socket sock, non_null() IP_Port *ip_port, non_null() uint8_t *data, non_null() uint32_t *length)
{
