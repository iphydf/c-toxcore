...
typedef enum Tox_Event_Type {
    ...
    TOX_EVENT_SELF_CONNECTION_STATUS        = 1,

    TOX_EVENT_FRIEND_REQUEST                = 2,
    TOX_EVENT_FRIEND_CONNECTION_STATUS      = 3,
    TOX_EVENT_FRIEND_LOSSY_PACKET           = 4,
    TOX_EVENT_FRIEND_LOSSLESS_PACKET        = 5,

    TOX_EVENT_FRIEND_NAME                   = 6,
    TOX_EVENT_FRIEND_STATUS                 = 7,
    TOX_EVENT_FRIEND_STATUS_MESSAGE         = 8,

    TOX_EVENT_FRIEND_MESSAGE                = 9,
    TOX_EVENT_FRIEND_READ_RECEIPT           = 10,
    TOX_EVENT_FRIEND_TYPING                 = 11,

    TOX_EVENT_FILE_CHUNK_REQUEST            = 12,
    TOX_EVENT_FILE_RECV                     = 13,
    TOX_EVENT_FILE_RECV_CHUNK               = 14,
    TOX_EVENT_FILE_RECV_CONTROL             = 15,

    TOX_EVENT_CONFERENCE_INVITE             = 16,
    TOX_EVENT_CONFERENCE_CONNECTED          = 17,
    TOX_EVENT_CONFERENCE_PEER_LIST_CHANGED  = 18,
    TOX_EVENT_CONFERENCE_PEER_NAME          = 19,
    TOX_EVENT_CONFERENCE_TITLE              = 20,

    TOX_EVENT_CONFERENCE_MESSAGE            = 21,

    TOX_EVENT_MAX                           = TOX_EVENT_CONFERENCE_MESSAGE,
} Tox_Event_Type;

const char *tox_event_type_name(Tox_Event_Type type);
