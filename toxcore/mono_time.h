...
Mono_Time *_Nullable mono_time_new(const Memory *_Nonnull mem, const Tox_Time *_Nullable tm);
 ...
 */
void mono_time_set_current_time_callback(Mono_Time *_Nonnull mono_time, const Tox_Time *_Nullable tm);
#ifdef __cplusplus
} /* extern "C" */
#endif
