...
int Test_Network::close(void *obj, Socket sock) { return net->funcs->close_callback(net->user_data, sock); }
Socket Test_Network::accept(void *obj, Socket sock) { return net->funcs->accept_callback(net->user_data, sock); }
...
int Test_Network::recvbuf(void *obj, Socket sock) { return net->funcs->recvbuf_callback(net->user_data, sock); }
