...
Announcements *new_announcements(
    non_null const Logger *log,
    non_null const Memory *mem,
    non_null const Random *rng,
    non_null const Mono_Time *mono_time,
    non_null Forwarding *forwarding);
 ...
 */
bool announce_on_stored(
        non_null const Announcements *announce,
        non_null const uint8_t *data_public_key,
        nullable announce_on_retrieve_cb *on_retrieve_callback,
...
/** @private */
bool announce_store_data(
    non_null Announcements *announce,
    non_null const uint8_t *data_public_key,
